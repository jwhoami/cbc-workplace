...
![Resultados filtrados por la palabra clave "pastor".](../screenshots/user/user-public-search-keyword.png)
...
![Estado vacío cuando ninguna oferta coincide con la búsqueda.](../screenshots/user/user-public-empty-state.png)
...
![Detalle de una oferta con descripción completa y botón Postular.](../screenshots/user/user-public-offer-detail.png)
