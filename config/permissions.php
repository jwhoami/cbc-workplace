...
return [
    ...
    ['id' => 'Admin.JobListing', 'parent' => 'app', 'text' => 'Admin Ofertas de Empleo'],
    ['id' => 'Admin.JobListing.viewAny', 'parent' => 'Admin.JobListing', 'text' => 'Listar'],
    ['id' => 'Admin.JobListing.view', 'parent' => 'Admin.JobListing', 'text' => 'Ver'],
    ['id' => 'Admin.JobListing.approve-job-listing', 'parent' => 'Admin.JobListing', 'text' => 'Aprobar Oferta'],
    ...
    ['id' => 'Member.JobListing', 'parent' => 'app', 'text' => 'Ofertas de Empleo'],
    ['id' => 'Member.JobListing.viewAny', 'parent' => 'Member.JobListing', 'text' => 'Listar'],
    ['id' => 'Member.JobListing.create', 'parent' => 'Member.JobListing', 'text' => 'Crear'],
    ['id' => 'Member.JobListing.view', 'parent' => 'Member.JobListing', 'text' => 'Ver'],
    ['id' => 'Member.JobListing.update', 'parent' => 'Member.JobListing', 'text' => 'Editar'],
    ['id' => 'Member.JobListing.delete', 'parent' => 'Member.JobListing', 'text' => 'Eliminar'],
    ['id' => 'Member.JobListing.submit-job-listing', 'parent' => 'Member.JobListing', 'text' => 'Enviar a Aprobación'],
    ['id' => 'Member.JobListing.close-job-listing', 'parent' => 'Member.JobListing', 'text' => 'Cerrar Oferta'],
