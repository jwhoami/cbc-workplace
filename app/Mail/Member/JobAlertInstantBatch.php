...
class JobAlertInstantBatch extends Mailable
{
    ...
    public function __construct(
        ...
        $this->onQueue('instant');
    }

    public function envelope(): Envelope
    {
        return new Envelope(
            subject: __('mail/job-alert.instant.subject', ['count' => $this->offers->count()]),
        );
    }
    ...
    {
        return new Content(
            markdown: 'mail.member.job-alert-instant-batch',
            with: [
                'alert' => $this->alert,
                'offers' => $this->offers,
